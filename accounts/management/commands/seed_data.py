...
class Command(BaseCommand):
    ...
    def seed_conventions(self):
        ...
        obj, created = Convention.objects.update_or_create(
            ...
            defaults=dict(
                ...
                credentials_deadline=datetime.date(2026, 5, 31),
                travel_plan_deadline=datetime.date(2026, 9, 7),
                late_fee=Decimal('0.00'),
                days_prior_to_start=3,
                is_active=True,
                # Accommodation package prices (2025 filler values)
                price_full_package_3_nights=Decimal('905.00'),
                price_full_package_4_nights=Decimal('1015.00'),
                price_banquet_only=Decimal('68.00'),
                price_banquet_one_night=Decimal('178.00'),
                price_banquet_one_night_single=Decimal('288.00'),
                price_3_nights_no_meals=Decimal('330.00'),
                price_4_nights_no_meals=Decimal('440.00'),
                price_3_nights_plus_meals=Decimal('638.00'),
                price_4_nights_plus_meals=Decimal('748.00'),
                price_3_nights_banquet_only=Decimal('398.00'),
                price_4_nights_banquet_only=Decimal('508.00'),
                # Fee code fields (2025 filler values)
                fee_p4=Decimal('500.00'),
                fee_f1=Decimal('110.00'),
                fee_f2=Decimal('220.00'),
                fee_h1=Decimal('65.00'),
                fee_h2=Decimal('68.00'),
                fee_h3=Decimal('68.00'),
                fee_m1=Decimal('65.00'),
                fee_m2=Decimal('42.00'),
                fee_m3=Decimal('68.00'),
                fee_m4=Decimal('68.00'),
            ),
        )
    ...
    def seed_booth_packages(self, convention):
        ...
        data = [
            ...
            dict(
                name='Virtual Booth + Extra Promotion*',
                description='',
            ...
            dict(
                name='Virtual and In-Person Silver Booth',
                description='',
            ...
            dict(
                name='Virtual and In-Person Gold Booth',
                description='',
            ...
            dict(
                name='Virtual and In-Person Platinum Booth',
                description='',
